> Superseded in part by `2026-06-19-simplify-salt-pepper-split.md` (2026-06-19): the per-line approval-blocking and `js/rules.js` were removed. The Python CI data gate and the order-level Approve step remain.
